<template>
  <tapir-widget class="mt-20" :time="2" submit-label="byt" :successfulUpload="success" :failedUpload="failed"
    :afterRecording="afterRec" :showButton="false" :backendEndpoint="backendEndpoint" buttonColor="rgb(16, 185, 129)"
